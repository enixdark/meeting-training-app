...
class DisapprovalEmailTask(BaseRetrieveMeetingEmailTask):
    DISAPPROVAL_EMAIL_SUBJECT = 'Thông báo bác bỏ yêu cầu.'

    def _create_email_subject(self) -> str:
        return self.DISAPPROVAL_EMAIL_SUBJECT
    ...
    def _create_html_body(self) -> str:
        ...
        rendered_html = renderer.render(name='Yêu cầu đã bị bác bỏ', content=content)
