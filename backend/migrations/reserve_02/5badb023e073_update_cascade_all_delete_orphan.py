...
def upgrade():
    ...
    op.create_foreign_key(None, 'meeting', 'user', ['creator_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(None, 'meeting', 'location_seeder', ['location_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key(None, 'meeting_user', 'user', ['user_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(None, 'meeting_user', 'meeting', ['meeting_id'], ['id'], ondelete='CASCADE')
...
def downgrade():
    ...
    op.create_foreign_key('meeting_location_id_fkey', 'meeting', 'location_seeder', ['location_id'], ['id'])
    # ### end Alembic commands ###
